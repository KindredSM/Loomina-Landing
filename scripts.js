document.addEventListener("DOMContentLoaded", () => {
  ...
  const popupVideo = videoPopup
    ? videoPopup.querySelector(".video-popup-video")
    : null;

  const openVideoPopup = () => {
    if (!videoPopup || !popupVideo || !headerVideo) return;
    if (!popupVideo.src && headerVideo.dataset && headerVideo.dataset.src) {
